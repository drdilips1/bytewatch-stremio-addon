...
const RELAY_HOSTS = /^(sentry\.libbyapp\.com|thunder\.api\.overdrive\.com|api\.hardcover\.app|api\.audible\.[a-z.]+|www\.goodreads\.com|(www\.)?getstoryshots\.com|www\.blinkist\.com|itunes\.apple\.com)$/i;
