// Vendored unchanged from https://github.com/k2-fsa/sherpa-onnx (v1.13.8), Apache License 2.0.
// It must match the native libsherpa-onnx-jni.so version downloaded by the build (see README).
